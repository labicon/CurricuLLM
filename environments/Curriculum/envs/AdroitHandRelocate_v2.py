...
class AdroitHandRelocateEnv(MujocoEnv, EzPickle):
    ...
    * v0: legacy versions in the [D4RL](https://github.com/Farama-Foundation/D4RL).
    ...
    def compute_reward_3(self):
        ...
        ball_to_target_distance = np.linalg.norm(self.positional_difference_from_ball_to_target())
        
        # Reward components
        ball_to_target_distance_reward = -ball_to_target_distance  # Minimize the distance
        reward_components = {
            'ball_to_target_distance': ball_to_target_distance_reward
        }
        
        # Define weights for each component
        weight_ball_to_target = 1.0
        
        # Total reward calculation
        total_reward = weight_ball_to_target * ball_to_target_distance_reward
