...
from train_walker import Curriculum_Module, Reward_Addition_Module, SAC_Module

if __name__ == "__main__":
    seed = 14
    
    env_name = "Walker2d"
    env_path = "./environments/Curriculum/envs/Walker2d.py"
    logger_path = f"./logs/Walker2d_{seed}/"
