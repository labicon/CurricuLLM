...
import orbit.berkeley_humanoid.tasks.locomotion.llm_curriculum.mdp as mdp
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    contact_forces = ContactFootHeightSensorCfg(
...
class RandomizationCfg:
    ...
    scale_all_joint_friction_model = RandTerm(
...
class RewardsCfg:
    ...
    termination = RewTerm(func=mdp.is_alive, weight=1.0)
    # -- task
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        debug_vis=True,
        ranges=mdp.UniformVelocityCommandCfg.Ranges(lin_vel_x=(-2.0, 2.0), lin_vel_y=(-2.0, 2.0), ang_vel_z=(-0.5, 0.5), heading=(-math.pi, math.pi)),
