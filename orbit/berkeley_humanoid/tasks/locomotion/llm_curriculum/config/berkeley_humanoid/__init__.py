...
gym.register(
    id="Velocity-Flat-Berkeley-Curriculum-Humanoid-v0",
...
gym.register(
    id="Velocity-Flat-Berkeley-Curriculum-Humanoid-Play-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Velocity-Rough-Berkeley-Curriculum-Humanoid-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Velocity-Rough-Berkeley-Curriculum-Humanoid-Play-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
