...
from train_fetch_slide import Curriculum_Module, HER_Module, SAC_Module, Scratch_Module
...
if __name__ == "__main__":
    ...
    env_name = "FetchSlide"
    env_path = "./environments/Curriculum/envs/FetchSlide_source.py" # FetchPush.py
    logger_path = f"./logs/Fetch/Slide_updated_{seed}/" # f"./logs/Fetch/Push_{seed}/"
